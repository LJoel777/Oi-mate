...
public class TestQuestionData {
    public static List<Question> questionList = new ArrayList<>() {{
        ...
        add(new Question("What does a sdsa do?", "Please help me!!" ,"", 3));
        add(new Question("What does a streasadsam do?", "Please help me!!" ,"", 4));
        add(new Question("What does a stresddsam do?", "Please help me!!" ,"", 10));
